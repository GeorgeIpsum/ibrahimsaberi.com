...
Assuming you're on macOS, you can simply `brew install go{:bash}` (and then do some $PATH setting which I don't remember exactly) and you can jump right in.
...
> !FIGCAP Hey, look. Sometimes all that matters is that it just works.
