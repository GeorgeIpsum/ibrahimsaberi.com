...
> [!CAUTION]
> This post is like 95% straight up taken [from](https://edwardtufte.github.io/tufte-css/) [others](https://clayh53.github.io/tufte-jekyll/articles/20/tufte-style-jekyll-blog) on Tufte CSS.
...
> !QUOTE [A] reminder about the goal of this project. The web is not print. Webpages are not books. Therefore, the goal of Tufte CSS is not to say “websites should look like this interpretation of Tufte's books” but rather “here are some techniques Tufte developed that we've found useful in print; maybe you can find a way to make them useful on the web”. Tufte CSS is merely a sketch of one way to implement this particular set of ideas. It should be a starting point, not a design goal, because any project should present their information as best suits their particular circumstances.
>
> !VIA Dave Liepmann, [forum post, 'Book design: advice and examples' thread](http://www.edwardtufte.com/bboard/q-and-a-fetch-msg?msg_id=0000hB)
...
> !QUOTE Perhaps you have noticed their use in this document already. You are very astute.
>
> !VIA Dave Liepmann
...
<figure>
<iframe src="https://www.youtube.com/embed/YslQ2625TR4" allowFullScreen></iframe>
</figure>
...
Tables are designed with an `overflow: scroll;` property to create slider bars when the viewport is narrow. This is so that you do not collapse all your beautiful data into a jumble of letters and numbers when you view it on your smartphone.[^table_1]
...
[^table]: <cite>Page 139, _The Visual Display of Quantitative Information_, Edward Tufte 2001.</cite>
