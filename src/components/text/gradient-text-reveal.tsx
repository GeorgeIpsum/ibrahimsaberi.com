...
/**
 * Props for {@link GradientTextReveal}.
 */
export interface GradientTextRevealProps
  ...
  > {
  /**
   * Text to reveal. Pass multiple strings to rotate when {@link GradientTextRevealProps.repeat} is `true`.
   */
  text: string | string[];
  /**
  ...
  repeat?: boolean;
  /**
   * Pause between cycles when {@link GradientTextRevealProps.repeat} is `true`, in seconds.
   * @defaultValue `0.5`
   */
  repeatDelay?: number;
  /**
