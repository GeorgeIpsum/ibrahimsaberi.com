...
const Crash: React.FC = () => {
  ...
  return (
    <div className="crash fixed bottom-0 right-0 flex w-full flex-col bg-zinc-50/40 px-2 dark:bg-slate-950/30 sm:mx-6 sm:w-[300px] sm:min-w-96 sm:rounded-t-xl md:mx-2 lg:relative lg:mx-0 lg:ml-auto lg:h-[100vh] lg:w-[400px]">
      <Display />
