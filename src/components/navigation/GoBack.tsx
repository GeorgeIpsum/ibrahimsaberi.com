...
const GoBack: React.FC<GoBackProps> = ({ className, svgProps = {} }) => {
  ...
  return (
    <div
      className={cx(
        className,
        "flex w-auto cursor-pointer items-center gap-1 py-3 pl-3 pr-12"
      )}
      onClick={goBack}
    >
      <svg
      ...
      <div className="font-head text-sm uppercase">Go Back</div>
    </div>
  );
};
