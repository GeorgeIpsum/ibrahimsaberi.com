...
export function DrawerFooter({
  ...
  const defaultProps = {
    className: cn(
      ...
      !allowSelection && "cursor-default",
      variant === "default" &&
        "border-t bg-muted/72 pt-4 pb-[calc(env(safe-area-inset-bottom,0)+(--spacing(4)))]",
      variant === "bare" &&
        "in-[[data-slot=drawer-popup]:has([data-slot=drawer-panel])]:pt-3 pt-4 pb-[calc(env(safe-area-inset-bottom,0)+(--spacing(6)))]",
      className,
    ),
